...
function tora_panic(code, msg, detail) {
    return new ToraError(code, msg, detail);
}
function throw_tora_panic(code, msg, detail) {
    throw new ToraError(code, msg, detail);
}
function throw_panic(msg) {
    throw new Error(msg);
}
function finish(ctx, data) {
...
class SessionContext {
    ...
    get user() {
        var _a, _b;
        return (_b = (_a = this.auth) === null || _a === void 0 ? void 0 : _a.get_user_info()) !== null && _b !== void 0 ? _b : throw_tora_panic(401, 'Unauthorized.');
    }
    get maybe_user() {
        var _a;
...
export { AnnotationTools, ApiParams, Auth, Authenticator, CacheProxy, CacheWith, ClassProvider, Component, CurrentTimestamp, Delete, Disabled, FactoryProvider, FinishProcess, Get, Inject, Injector, Judgement, LifeCycle, LocalFinishProcess, Meta, NoWrap, NullInjector, PURE_PARAMS, Platform, Post, Put, Router, SessionContext, SessionData, ToraError, ToraKoa, ToraModule, ToraServer, UUID, ValueProvider, def2Provider, finish, throw_panic, throw_tora_panic, tora_panic };
