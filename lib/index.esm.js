...
class SessionContext {
    ...
    get real_ip() {
        var _a;
        return (_a = this.ctx.request.get('X-Real-Ip')) !== null && _a !== void 0 ? _a : this.ctx.ip;
    }
    /**
 ...
 * @param indent
 */
function find_usage(tree_node, indent = 0) {
    var _a, _b;
    return ((_a = tree_node === null || tree_node === void 0 ? void 0 : tree_node.providers) === null || _a === void 0 ? void 0 : _a.find(p => p.used)) || ((_b = tree_node === null || tree_node === void 0 ? void 0 : tree_node.children) === null || _b === void 0 ? void 0 : _b.find(t => find_usage(t, indent + 1)));
}
...
function createRequestDecorator(method) {
    return (router_path) => (target, key, desc) => {
        var _a, _b, _c;
        const handler = AnnotationTools.get_set_meta_data(DI_TOKEN.request_handler, target, key, {});
        if (!handler.methods) {
        ...
        const handlers = AnnotationTools.get_set_meta_data(DI_TOKEN.router_handlers, target, undefined, []);
...
function makeRouterCollector(target, path, options) {
    return function (injector) {
        ...
        const handlers = AnnotationTools.get_set_meta_data(DI_TOKEN.router_handlers, target.prototype, undefined, []);
...
export { AnnotationTools, ApiParams, Auth, Authenticator, CacheProxy, CacheWith, ClassProvider, Component, CurrentTimestamp, Delete, Disabled, FactoryProvider, Get, Inject, Injector, Judgement, LifeCycle, Meta, NoWrap, NullInjector, PURE_PARAMS, Platform, Post, Put, ResultWrapper, Router, SessionContext, SessionData, ToraModule, ToraServer, UUID, ValueProvider, crash, reasonable, response, throw_reasonable };
