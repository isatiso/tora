...
function Inject(token) {
    return function (proto, key, index) {
        const injection = exports.AnnotationTools.get_set_meta_data(FM_DI_TOKEN.param_injection, proto, key, {});
...
function createRequestDecorator(method) {
    return (router_path) => (target, key, desc) => {
        var _a, _b, _c;
        const handler = exports.AnnotationTools.get_set_meta_data(FM_DI_TOKEN.request_handler, target, key, {});
        if (!handler.methods) {
        ...
        const handlers = exports.AnnotationTools.get_set_meta_data(FM_DI_TOKEN.router_handlers, target, undefined, []);
...
function makeRouterCollector(target, path, options) {
    return function (injector) {
        ...
        const handlers = exports.AnnotationTools.get_set_meta_data(FM_DI_TOKEN.router_handlers, target.prototype, undefined, []);
...
exports.FmServer = FmServer;
exports.Get = Get;
exports.Inject = Inject;
exports.Injector = Injector;
exports.Judgement = Judgement;
exports.LifeCycle = LifeCycle;
exports.LocalFinishProcess = LocalFinishProcess;
...
exports.def2Provider = def2Provider;
exports.finish = finish;
exports.fm_panic = fm_panic;
exports.throw_fm_panic = throw_fm_panic;
exports.throw_local_panic = throw_local_panic;
